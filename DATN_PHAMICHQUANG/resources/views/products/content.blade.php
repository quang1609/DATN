                            ...
                            <div class="wrap-slick3-dots">
                                <ul class="slick3-dots" style="" role="tablist">
                                    <li class="slick-active" role="presentation">
                                        <img src="{{ asset('images/products/' . $product->thumb) }}">
                                    ...
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        <div class="item-slick3 slick-slide slick-current slick-active"
                                            ...
                                            <div class="wrap-pic-w pos-relative">
                                                <img src="{{ asset('images/products/' . $product->thumb) }}" alt="IMG-PRODUCT" width="550px" height="600px">

                                                <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                   href="{{ asset('images/products/' . $product->thumb) }}" tabindex="0">
                        ...
                        {{-- <div class="flex-w flex-m p-l-100 p-t-40 respon7">
                            <div class="flex-m bor9 p-r-10 m-r-11">
                                <a href="javascript:void(0)" data-id={{ $product->id }}
                                   class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail tooltip100 addwishlist"
